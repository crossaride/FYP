...
<html lang="en">
    <head>
        ...
        <!-- Paypal -->
        <!-- Replace "YOUR_CLIENT_ID" with your own sandbox account app client ID -->
        <!-- "en_US"  is language and country, for the components to render them in-->
                    ...
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform">
                            ...
                            <fieldset>
                                ...
                                <!-- You can add another option to submit the form -->
                                <!-- <input type="submit" name="submit" class="action-button" value="Submit" formaction="Servlet"> -->
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                            </fieldset>
                        </form>
                    </div>
